...
export const HomeDetailsOwner = () => {
  ...
  const [moveInDate, setMoveInDate] = useState(
    moment(home.moveInDate).format("YYYY-MM-DD")
  );
        ...
        <button onClick={handleShowPendingRequests}>
          {showPendingRequests ? (
            <h1 className="ml-2 flex items-center">
              ...
              Return to home details
            </h1>
          ) : (
            <h1 className="ml-2">Go to Pending Requests</h1>
          )}
        </button>
      </div>
      {loading ? (
        ...
        <HomePendingRequests pendingMembers={home.pendingMembers} homeId={id} />
      ) : (
        <>
          <div className="p-4">
            <h1 className="text-4xl mb-4 text-text text-center">
              Home Details
            </h1>
            <div className="grid grid-cols-2">
              <div className="flex flex-col gap-8 px-4">
                ...
                <button
                  className="text-text bg-secondary px-4 py-2 rounded-md"
              ...
              <div className="flex flex-col justify-center text-text">
                ...
                >
                  ...
                  {/* Bathrooms */}
                  <div className="flex items-center justify-between lg:col-span-1 sm:col-span-1">
                    <label className="text-text text-2xl mr-4">
                      Bathrooms:
                    </label>
                    <input
                      type="number"
