...
const { getHomeById, createHome, getAllHomes, updateHomeById, joinReqHome , acceptUserRequest, rejectUserRequest, homeMateRetrival } = require('../controllers/homeController');
